...
export default function JoinShipamPage() {
  const handle_signup = (signup_as: string) => {
    location.assign(
      `${location.protocol}//${signup_as}.${location.host}/auth/register`
    );
  };
  return (
